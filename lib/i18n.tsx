...
const translations = {
    ka: {
        ...
        "services.cat.cleaning": "დალაგება",
        "services.cat.dry_cleaning": "ქიმწმენდა",
        ...
        "services.desc.renovation": "სრული დასუფთავება რემონტის ან მშენებლობის შემდეგ. (ფანჯრების და ვიტრაჟების წმენდა: 12₾/მ²)",
        "services.dc.armchair": "კრესლო",
        "services.dc.sofa_1": "დივანი (1-ადგილიანი)",
        "services.dc.sofa_2": "დივანი (2-ადგილიანი)",
        "services.dc.mattress": "მატრასი",
        "services.dc.pouffe": "პუფი",
        ...
        "pricing.area": "საერთო ფართობი (მ²)",
        "pricing.window_area": "ფანჯრების ფართობი (მ²)",
    ...
    en: {
        ...
        "services.cat.dry_cleaning": "Dry Cleaning",
        ...
        "services.desc.renovation": "Complete cleanup after construction. (Window and stained glass cleaning: 12₾/m²)",
        "services.dc.armchair": "Armchair",
        "services.dc.sofa_1": "1-Seater Sofa",
        "services.dc.sofa_2": "2-Seater Sofa",
        "services.dc.mattress": "Mattress",
        "services.dc.pouffe": "Pouffe",
        "pricing.title": "Transparent Pricing",
        "pricing.service_type": "Select Service",
        "pricing.calc_desc": "Calculate cost based on service type and area.",
        "pricing.area": "Total Area (m²)",
        "pricing.window_area": "Window Area (m²)",
    ...
    ru: {
        ...
        "services.cat.cleaning": "Уборка",
        "services.cat.dry_cleaning": "Химчистка",
        ...
        "services.desc.renovation": "Полная уборка после строительства. (Мытье окон и витражей: 12₾/м²)",
        "services.dc.armchair": "Кресло",
        "services.dc.sofa_1": "Диван (1-местный)",
        "services.dc.sofa_2": "Диван (2-местный)",
        "services.dc.mattress": "Матрас",
        "services.dc.pouffe": "Пуф",
        ...
        "pricing.area": "Общая площадь (м²)",
        "pricing.window_area": "Площадь окон (м²)",
